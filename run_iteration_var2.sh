...
# Start the background profiler in ContainerB (uses the high-precision validation script profile_and_validate_var2.py)
echo "Launching background profiler in ContainerB..."
docker exec -d "$CONTAINER_B" python3 /validation/profile_and_validate_var2.py \
